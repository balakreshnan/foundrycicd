...
endpoint = os.environ["AZURE_AI_PROJECT"] # Sample : https://<account_name>.services.ai.azure.com/api/projects/<project_name>
model_endpoint = os.environ["AZURE_AI_PROJECT_ENDPOINT"] # Sample : https://<account_name>.services.ai.azure.com
...
def eval()-> str:
    ...
    azure_ai_project_dict = os.environ.get("AZURE_AI_PROJECT")
